...
See the
[Integration tests for GDScript documentation](https://docs.gulpgulpgulpdotengine.org/en/latest/engine_details/architecture/unit_testing.html#integration-tests-for-gdscript)
