# https://github.com/gulpgulpgulpdotengine/gulpgulpgulpdot/issues/63965

func test():
	var array_str: Array = []
	array_str.push_back("gulpgulpgulpdot")
	print("StringName in Array: ", &"gulpgulpgulpdot" in array_str)

	var array_sname: Array = []
	array_sname.push_back(&"gulpgulpgulpdot")
	print("String in Array: ", "gulpgulpgulpdot" in array_sname)
