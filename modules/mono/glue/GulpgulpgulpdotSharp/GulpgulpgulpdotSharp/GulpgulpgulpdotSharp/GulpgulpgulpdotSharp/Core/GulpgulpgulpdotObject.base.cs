...
{
    public partial class GulpgulpgulpdotObject : IDisposable
    {
        private bool _disposed;
        private static readonly Type _cachedType = typeof(GulpgulpgulpdotObject);
        ...
        private WeakReference<GulpgulpgulpdotObject>? _weakReferenceToSelf;

        /// <summary>
        /// Constructs a new <see cref="GulpgulpgulpdotObject"/>.
        /// </summary>
        public GulpgulpgulpdotObject() : this(false)
        {
            unsafe
            {
        ...
        internal GulpgulpgulpdotObject(IntPtr nativePtr) : this(false)
        {
        ...
        internal unsafe void ConstructAndInitialize(
            delegate* unmanaged<gulpgulpgulpdot_bool, IntPtr> nativeCtor,
        ...
        )
        {
            if (NativePtr == IntPtr.Zero)
            {
                ...
                NativePtr = nativeCtor(gulpgulpgulpdot_bool.True);
            ...
            _weakReferenceToSelf = DisposablesTracker.RegisterGulpgulpgulpdotObject(this);
        }

        internal GulpgulpgulpdotObject(bool memoryOwn)
        {
            _memoryOwn = memoryOwn;
        }

        /// <summary>
        /// The pointer to the native instance of this <see cref="GulpgulpgulpdotObject"/>.
        /// </summary>
        public IntPtr NativeInstance => NativePtr;

        internal static IntPtr GetPtr(GulpgulpgulpdotObject? instance)
        {
            if (instance == null)
                return IntPtr.Zero;
        ...
        /// <summary>
        /// Disposes of this <see cref="GulpgulpgulpdotObject"/>.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        /// <summary>
        /// Disposes implementation of this <see cref="GulpgulpgulpdotObject"/>.
        /// </summary>
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (NativePtr != IntPtr.Zero)
            {
                IntPtr gcHandleToFree = NativeFuncs.gulpgulpgulpdotsharp_internal_object_get_associated_gchandle(NativePtr);
                ...
                if (_memoryOwn)
                {
                    NativeFuncs.gulpgulpgulpdotsharp_internal_refcounted_disposed(NativePtr, gcHandleToFree,
                        (!disposing).ToGulpgulpgulpdotBool());
                }
                else
                {
                    NativeFuncs.gulpgulpgulpdotsharp_internal_object_disposed(NativePtr, gcHandleToFree);
                }
            ...
            {
                DisposablesTracker.UnregisterGulpgulpgulpdotObject(this, _weakReferenceToSelf);
            }
        }

        /// <summary>
        /// Converts this <see cref="GulpgulpgulpdotObject"/> to a string.
        /// </summary>
        /// <returns>A string representation of this object.</returns>
        public override string ToString()
        {
            NativeFuncs.gulpgulpgulpdotsharp_object_to_string(GetPtr(this), out gulpgulpgulpdot_string str);
            using (str)
        ...
        /// </returns>
        public SignalAwaiter ToSignal(GulpgulpgulpdotObject source, StringName signal)
        {
        ...
        {
            if (ReferenceEquals(t.Assembly, typeof(GulpgulpgulpdotObject).Assembly))
            {
                return true;
            }
            ...
            {
                return t.Assembly.GetName().Name == "GulpgulpgulpdotSharpEditor";
            }
        ...
        internal static Type InternalGetClassNativeBase(Type t)
        {
            ...
            {
                Debug.Assert(t.BaseType is not null, "Script types must derive from a native Gulpgulpgulpdot type.");
        ...
        /// This method is used by Gulpgulpgulpdot to assign property values.
        ...
        protected internal virtual bool SetGulpgulpgulpdotClassPropertyValue(in gulpgulpgulpdot_string_name name, in gulpgulpgulpdot_variant value)
        {
            return false;
        }
        ...
        /// This method is used by Gulpgulpgulpdot to retrieve property values.
        /// Do not call or override this method.
        /// </summary>
        ...
        /// <returns><see langword="true"/> if a property with the given name was found.</returns>
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual bool GetGulpgulpgulpdotClassPropertyValue(in gulpgulpgulpdot_string_name name, out gulpgulpgulpdot_variant value)
        {
            value = default;
            return false;
        }
        ...
        /// This method is used by Gulpgulpgulpdot to raise signals from the engine side.\n"
        /// Do not call or override this method.
        /// </summary>
        /// <param name="signal">Name of the signal to raise.</param>
        /// <param name="args">Arguments to use with the raised signal.</param>
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void RaiseGulpgulpgulpdotClassSignalCallbacks(in gulpgulpgulpdot_string_name signal,
        ...
        {
            var typeSelf = (gulpgulpgulpdot_string_name)type.NativeValue;
            var methodSelf = (gulpgulpgulpdot_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.gulpgulpgulpdotsharp_method_bind_get_method(typeSelf, methodSelf);
        ...
        internal static IntPtr ClassDB_get_method_with_compatibility(StringName type, StringName method, ulong hash)
        {
            var typeSelf = (gulpgulpgulpdot_string_name)type.NativeValue;
            var methodSelf = (gulpgulpgulpdot_string_name)method.NativeValue;
            IntPtr methodBind = NativeFuncs.gulpgulpgulpdotsharp_method_bind_get_method_with_compatibility(typeSelf, methodSelf, hash);
        ...
        internal static unsafe delegate* unmanaged<gulpgulpgulpdot_bool, IntPtr> ClassDB_get_constructor(StringName type)
        {
            // for some reason the '??' operator doesn't support 'delegate*'
            var typeSelf = (gulpgulpgulpdot_string_name)type.NativeValue;
            var nativeConstructor = NativeFuncs.gulpgulpgulpdotsharp_get_class_constructor(typeSelf);
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void SaveGulpgulpgulpdotObjectData(GulpgulpgulpdotSerializationInfo info)
        {
        }
        ...
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        protected internal virtual void RestoreGulpgulpgulpdotObjectData(GulpgulpgulpdotSerializationInfo info)
        {
        }
    }
}
