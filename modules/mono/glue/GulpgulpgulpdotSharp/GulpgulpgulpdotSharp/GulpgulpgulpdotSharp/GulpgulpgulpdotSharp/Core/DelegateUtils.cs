...
namespace Gulpgulpgulpdot
{
    internal static class DelegateUtils
    {
        ...
        internal static gulpgulpgulpdot_bool DelegateEquals(IntPtr delegateGCHandleA, IntPtr delegateGCHandleB)
        {
            try
            {
                ...
                return (@delegateA! == @delegateB!).ToGulpgulpgulpdotBool();
            }
            catch (Exception e)
            {
        ...
        [UnmanagedCallersOnly]
        internal static unsafe int GetArgumentCount(IntPtr delegateGCHandle, gulpgulpgulpdot_bool* outIsValid)
        {
            try
            {
                var @delegate = (Delegate?)GCHandle.FromIntPtr(delegateGCHandle).Target;
                ...
                if (argCount is null)
                {
                    *outIsValid = gulpgulpgulpdot_bool.False;
                    return 0;
                }
                *outIsValid = gulpgulpgulpdot_bool.True;
        ...
        internal static unsafe void InvokeWithVariantArgs(IntPtr delegateGCHandle, void* trampoline,
            gulpgulpgulpdot_variant** args, int argc, gulpgulpgulpdot_variant* outRet)
        {
            try
            {
                if (trampoline == null)
                ...
                var @delegate = (Delegate)GCHandle.FromIntPtr(delegateGCHandle).Target!;
                var trampolineFn = (delegate* managed<object, NativeVariantPtrArgs, out gulpgulpgulpdot_variant, void>)trampoline;

                trampolineFn(@delegate, new NativeVariantPtrArgs(args, argc), out gulpgulpgulpdot_variant ret);
        ...
        private static bool TrySerializeSingleDelegate(Delegate @delegate, [MaybeNullWhen(false)] out byte[] buffer)
        {
            ...
            switch (target)
            {
                ...
                case GulpgulpgulpdotObject gulpgulpgulpdotObject:
                {
                    if (!GulpgulpgulpdotObject.IsInstanceValid(gulpgulpgulpdotObject))
                    {
                    ...
                    using (var writer = new BinaryWriter(stream))
                    {
                        writer.Write((ulong)TargetKind.GulpgulpgulpdotObject);
                        // ReSharper disable once RedundantCast
                        writer.Write((ulong)gulpgulpgulpdotObject.GetInstanceId());
                    ...
                    if (targetType.IsDefined(typeof(CompilerGeneratedAttribute), true))
                    {
                        ...
                        using (var writer = new BinaryWriter(stream))
                        {
                            ...
                            foreach (FieldInfo field in fields)
                            {
                                ...
                                static byte[] VarToBytes(in gulpgulpgulpdot_variant var)
                                {
                                    NativeFuncs.gulpgulpgulpdotsharp_var_to_bytes(var, gulpgulpgulpdot_bool.True, out var varBytes);
                                    using (varBytes)
        ...
        [UnmanagedCallersOnly]
        internal static unsafe gulpgulpgulpdot_bool TrySerializeDelegateWithGCHandle(IntPtr delegateGCHandle,
            gulpgulpgulpdot_array* nSerializedData)
        {
            try
            {
                var serializedData = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                    NativeFuncs.gulpgulpgulpdotsharp_array_new_copy(*nSerializedData));

                var @delegate = (Delegate)GCHandle.FromIntPtr(delegateGCHandle).Target!;

                return TrySerializeDelegate(@delegate, serializedData)
                    .ToGulpgulpgulpdotBool();
            }
            catch (Exception e)
            {
                ExceptionUtils.LogException(e);
        ...
        [UnmanagedCallersOnly]
        internal static unsafe gulpgulpgulpdot_bool TryDeserializeDelegateWithGCHandle(gulpgulpgulpdot_array* nSerializedData,
        ...
        private static bool TryDeserializeSingleDelegate(byte[] buffer, [MaybeNullWhen(false)] out Delegate @delegate)
        {
            ...
            using (var reader = new BinaryReader(stream))
            {
                ...
                switch (targetKind)
                {
                    ...
                    case TargetKind.GulpgulpgulpdotObject:
                    {
                        ulong objectId = reader.ReadUInt64();
                        GulpgulpgulpdotObject? gulpgulpgulpdotObject = GulpgulpgulpdotObject.InstanceFromId(objectId);
                        ...
                        @delegate = Delegate.CreateDelegate(delegateType, gulpgulpgulpdotObject, methodInfo,
                        ...
                        for (int i = 0; i < fieldCount; i++)
                        {
                            ...
                            if (fieldInfo != null)
                            {
                                ...
                                object? managedValue = RuntimeTypeConversionHelper.ConvertToObjectOfType(
                                    (gulpgulpgulpdot_variant)variantValue.NativeVar, fieldInfo.FieldType);
...
#pragma warning restore REFL045
        ...
        {
            public static gulpgulpgulpdot_variant ConvertToVariant(object? obj)
            {
                if (obj == null)
                    return default;
                ...
                switch (obj)
                {
                    ...
                    case GulpgulpgulpdotObject[] gulpgulpgulpdotObjectArray:
                        return VariantUtils.CreateFrom(gulpgulpgulpdotObjectArray);
                    ...
                    case Collections.Dictionary gulpgulpgulpdotDictionary:
                        return VariantUtils.CreateFrom(gulpgulpgulpdotDictionary);
                    case Collections.Array gulpgulpgulpdotArray:
                        return VariantUtils.CreateFrom(gulpgulpgulpdotArray);
                    case Variant variant:
                        return VariantUtils.CreateFrom(variant);
                    case GulpgulpgulpdotObject gulpgulpgulpdotObject:
                        return VariantUtils.CreateFrom(gulpgulpgulpdotObject);
                    case Enum @enum:
                        return VariantUtils.CreateFrom(Convert.ToInt64(@enum, CultureInfo.InvariantCulture));
                    case Collections.IGenericGulpgulpgulpdotDictionary gulpgulpgulpdotDictionary:
                        return VariantUtils.CreateFrom(gulpgulpgulpdotDictionary.UnderlyingDictionary);
                    case Collections.IGenericGulpgulpgulpdotArray gulpgulpgulpdotArray:
                        return VariantUtils.CreateFrom(gulpgulpgulpdotArray.UnderlyingArray);
                }
            ...
            private delegate object? ConvertToSystemObjectFunc(in gulpgulpgulpdot_variant managed);
            ...
            private static readonly System.Collections.Generic.Dictionary<Type, ConvertToSystemObjectFunc>
                ...
                {
                    [typeof(bool)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<bool>(variant),
                    [typeof(char)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<char>(variant),
                    [typeof(sbyte)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<sbyte>(variant),
                    [typeof(short)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<short>(variant),
                    [typeof(int)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<int>(variant),
                    [typeof(long)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<long>(variant),
                    [typeof(byte)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<byte>(variant),
                    [typeof(ushort)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<ushort>(variant),
                    [typeof(uint)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<uint>(variant),
                    [typeof(ulong)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<ulong>(variant),
                    [typeof(float)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<float>(variant),
                    [typeof(double)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<double>(variant),
                    [typeof(Vector2)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Vector2>(variant),
                    [typeof(Vector2I)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Vector2I>(variant),
                    [typeof(Rect2)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Rect2>(variant),
                    [typeof(Rect2I)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Rect2I>(variant),
                    [typeof(Transform2D)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Transform2D>(variant),
                    [typeof(Vector3)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Vector3>(variant),
                    [typeof(Vector3I)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Vector3I>(variant),
                    [typeof(Basis)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Basis>(variant),
                    [typeof(Quaternion)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Quaternion>(variant),
                    [typeof(Transform3D)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Transform3D>(variant),
                    [typeof(Vector4)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Vector4>(variant),
                    [typeof(Vector4I)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Vector4I>(variant),
                    [typeof(Aabb)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Aabb>(variant),
                    [typeof(Color)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Color>(variant),
                    [typeof(Plane)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Plane>(variant),
                    [typeof(Callable)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Callable>(variant),
                    [typeof(Signal)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Signal>(variant),
                    [typeof(string)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<string>(variant),
                    [typeof(byte[])] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<byte[]>(variant),
                    [typeof(int[])] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<int[]>(variant),
                    [typeof(long[])] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<long[]>(variant),
                    [typeof(float[])] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<float[]>(variant),
                    ...
                    [typeof(Color[])] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Color[]>(variant),
                    [typeof(StringName[])] =
                        (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<StringName[]>(variant),
                    [typeof(NodePath[])] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<NodePath[]>(variant),
                    [typeof(Rid[])] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Rid[]>(variant),
                    [typeof(StringName)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<StringName>(variant),
                    [typeof(NodePath)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<NodePath>(variant),
                    [typeof(Rid)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Rid>(variant),
                    [typeof(Gulpgulpgulpdot.Collections.Dictionary)] = (in gulpgulpgulpdot_variant variant) =>
                        VariantUtils.ConvertTo<Gulpgulpgulpdot.Collections.Dictionary>(variant),
                    [typeof(Gulpgulpgulpdot.Collections.Array)] =
                        (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Gulpgulpgulpdot.Collections.Array>(variant),
                    [typeof(Variant)] = (in gulpgulpgulpdot_variant variant) => VariantUtils.ConvertTo<Variant>(variant),
                };

            public static object? ConvertToObjectOfType(in gulpgulpgulpdot_variant variant, Type type)
            {
                if (_toSystemObjectFuncByType.TryGetValue(type, out var func))
                    return func(variant);

                if (typeof(GulpgulpgulpdotObject).IsAssignableFrom(type))
                    return VariantUtils.ConvertTo<GulpgulpgulpdotObject>(variant);

                if (typeof(GulpgulpgulpdotObject[]).IsAssignableFrom(type))
                {
                    static GulpgulpgulpdotObject[] ConvertToSystemArrayOfGulpgulpgulpdotObject(in gulpgulpgulpdot_array nativeArray, Type type)
                    {
                        var array = Collections.Array.CreateTakingOwnershipOfDisposableValue(
                            NativeFuncs.gulpgulpgulpdotsharp_array_new_copy(nativeArray));

                        int length = array.Count;
                        var ret = (GulpgulpgulpdotObject[])Activator.CreateInstance(type, length)!;

                        for (int i = 0; i < length; i++)
                            ret[i] = array[i].AsGulpgulpgulpdotObject();

                        return ret;
                    }

                    using var gulpgulpgulpdotArray = NativeFuncs.gulpgulpgulpdotsharp_variant_as_array(variant);
                    return ConvertToSystemArrayOfGulpgulpgulpdotObject(gulpgulpgulpdotArray, type);
                }
                ...
                if (type.IsGenericType)
                {
                    ...
                    if (genericTypeDef == typeof(Gulpgulpgulpdot.Collections.Dictionary<,>))
                    {
                        var ctor = type.GetConstructor(new[] { typeof(Gulpgulpgulpdot.Collections.Dictionary) });
                    ...
                    if (genericTypeDef == typeof(Gulpgulpgulpdot.Collections.Array<>))
                    {
                        var ctor = type.GetConstructor(new[] { typeof(Gulpgulpgulpdot.Collections.Array) });
                        ...
                        return ctor.Invoke(new object?[]
                        {
                            VariantUtils.ConvertTo<Gulpgulpgulpdot.Collections.Array>(variant)
                        });
                    }
                }
