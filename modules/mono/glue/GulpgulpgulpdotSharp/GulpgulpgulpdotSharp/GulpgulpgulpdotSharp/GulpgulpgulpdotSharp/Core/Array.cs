...
namespace Gulpgulpgulpdot.Collections
{
    /// <summary>
    /// Wrapper around Gulpgulpgulpdot's Array class, an array of Variant
...
#pragma warning restore CA1710
        ...
        IDisposable
    {
        internal gulpgulpgulpdot_array.movable NativeValue;
        ...
        public Array()
        {
            NativeValue = (gulpgulpgulpdot_array.movable)NativeFuncs.gulpgulpgulpdotsharp_array_new();
        ...
        /// <returns>A new Gulpgulpgulpdot Array.</returns>
        ...
        /// </exception>
        /// <returns>A new Gulpgulpgulpdot Array.</returns>
        public Array(scoped ReadOnlySpan<GulpgulpgulpdotObject> span)
        {
            NativeValue = (gulpgulpgulpdot_array.movable)NativeFuncs.gulpgulpgulpdotsharp_array_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        ...
        private Array(gulpgulpgulpdot_array nativeValueToOwn)
        {
            NativeValue = (gulpgulpgulpdot_array.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.gulpgulpgulpdotsharp_array_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Array CreateTakingOwnershipOfDisposableValue(gulpgulpgulpdot_array nativeValueToOwn)
        ...
        /// referenced in the source array. Note that any <see cref="GulpgulpgulpdotObject"/> derived
        ...
        {
            gulpgulpgulpdot_array newArray;
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_duplicate(ref self, deep.ToGulpgulpgulpdotBool(), out newArray);
        ...
        /// Note: If <paramref name="value"/> is of a reference type (<see cref="GulpgulpgulpdotObject"/>
        ...
        /// <example>
        /// <code>
        /// var array = new Gulpgulpgulpdot.Collections.Array();
        /// array.Resize(10);
        ...
        public void Fill(Variant value)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)value.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_fill(ref self, variantValue);
        }
        ...
        public Variant Max()
        {
            gulpgulpgulpdot_variant resVariant;
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_max(ref self, out resVariant);
        ...
        public Variant Min()
        {
            gulpgulpgulpdot_variant resVariant;
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_min(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Gulpgulpgulpdot.Collections.Array { 1, 2, 3, 4 };
        ...
        public Variant PickRandom()
        {
            gulpgulpgulpdot_variant resVariant;
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_pick_random(ref self, out resVariant);
            return Variant.CreateTakingOwnershipOfDisposableValue(resVariant);
        }
        ...
        {
            var self = (gulpgulpgulpdot_array)NativeValue;
            var otherVariant = (gulpgulpgulpdot_array)other.NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public Error Resize(int newSize)
        {
            ...
            var self = (gulpgulpgulpdot_array)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_resize(ref self, newSize);
        }
        ...
        public void Reverse()
        {
            ...
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_reverse(ref self);
        }
        ...
        public void Shuffle()
        {
            ...
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_shuffle(ref self);
        }
        ...
        public Array GetSliceRange(int start, int end, int step = 1, bool deep = false)
        {
            gulpgulpgulpdot_array newArray;
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_slice(ref self, start, end, step, deep.ToGulpgulpgulpdotBool(), out newArray);
            return CreateTakingOwnershipOfDisposableValue(newArray);
        }
        ...
        /// <example>
        /// <code>
        /// var strings = new Gulpgulpgulpdot.Collections.Array { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        ...
        public void Sort()
        {
            ...
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_sort(ref self);
        }
        ...
        /// <returns>A new Gulpgulpgulpdot Array with the contents of both arrays.</returns>
        ...
        public unsafe Variant this[int index]
        {
            get
            {
                GetVariantBorrowElementAt(index, out gulpgulpgulpdot_variant borrowElem);
            ...
            set
            {
                ...
                var self = (gulpgulpgulpdot_array)NativeValue;
                gulpgulpgulpdot_variant* ptrw = NativeFuncs.gulpgulpgulpdotsharp_array_ptrw(ref self);
                gulpgulpgulpdot_variant* itemPtr = &ptrw[index];
                (*itemPtr).Dispose();
        ...
        public void Add(Variant item)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            _ = NativeFuncs.gulpgulpgulpdotsharp_array_add(ref self, variantValue);
        }
        ...
        public void AddRange<[MustBeVariant] T>(IEnumerable<T> collection)
        {
            ...
            // If the collection is another Gulpgulpgulpdot Array, we can add the items
            // with a single interop call.
            if (collection is Array array)
            {
                var self = (gulpgulpgulpdot_array)NativeValue;
                var collectionNative = (gulpgulpgulpdot_array)array.NativeValue;
                _ = NativeFuncs.gulpgulpgulpdotsharp_array_add_range(ref self, collectionNative);
                return;
            }
            if (collection is Array<T> typedArray)
            {
                var self = (gulpgulpgulpdot_array)NativeValue;
                var collectionNative = (gulpgulpgulpdot_array)typedArray.NativeValue;
                _ = NativeFuncs.gulpgulpgulpdotsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        public int BinarySearch(int index, int count, Variant item)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_binary_search(ref self, index, count, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var arr = new Gulpgulpgulpdot.Collections.Array { "inside", 7 };
        ...
        public int IndexOf(Variant item)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_index_of(ref self, variantValue);
        }
        ...
        public int IndexOf(Variant item, int index)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public int LastIndexOf(Variant item)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_last_index_of(ref self, variantValue, Count - 1);
        }
        ...
        public int LastIndexOf(Variant item, int index)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_last_index_of(ref self, variantValue, index);
        }
        ...
        public void Insert(int index, Variant item)
        {
            ...
            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.NativeVar;
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_insert(ref self, index, variantValue);
        }
        ...
        public void RemoveAt(int index)
        {
            ...
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_remove_at(ref self, index);
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_make_read_only(ref self);
        }
        ...
        {
            var self = (gulpgulpgulpdot_array)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_to_string(ref self, out gulpgulpgulpdot_string str);
            using (str)
        ...
        /// <paramref name="index"/> is less than 0 or greater than the array's size.
        /// </exception>
        internal void GetVariantBorrowElementAt(int index, out gulpgulpgulpdot_variant elem)
        {
            if (index < 0 || index >= Count)
                throw new ArgumentOutOfRangeException(nameof(index));
        ...
        /// The variant returned via the <paramref name="elem"/> parameter is owned by the Array and must not be disposed.
        /// </summary>
        internal unsafe void GetVariantBorrowElementAtUnchecked(int index, out gulpgulpgulpdot_variant elem)
        {
    ...
    internal interface IGenericGulpgulpgulpdotArray
    {
        public Array UnderlyingArray { get; }
    }

    /// <summary>
    /// Typed wrapper around Gulpgulpgulpdot's Array class, an array of <typeparamref name="T"/>
    ...
    public sealed class Array<[MustBeVariant] T> :
        ...
        ICollection<T>,
        IEnumerable<T>,
        IGenericGulpgulpgulpdotArray
    {
        private static gulpgulpgulpdot_variant ToVariantFunc(scoped in Array<T> gulpgulpgulpdotArray) =>
            VariantUtils.CreateFromArray(gulpgulpgulpdotArray);

        private static Array<T> FromVariantFunc(in gulpgulpgulpdot_variant variant) =>
        ...
        private void SetTypedForUnderlyingArray()
        {
            ...
            using (elemScriptRef)
            {
                NativeFuncs.gulpgulpgulpdotsharp_array_set_typed(
                    ref self,
        ...
        Array IGenericGulpgulpgulpdotArray.UnderlyingArray => _underlyingArray;

        internal ref gulpgulpgulpdot_array.movable NativeValue
        {
        ...
        // Explicit name to make it very clear
        internal static Array<T> CreateTakingOwnershipOfDisposableValue(gulpgulpgulpdot_array nativeValueToOwn)
        ...
        /// <returns>A new Gulpgulpgulpdot Array, or <see langword="null"/> if <see paramref="from"/> was null.</returns>
        ...
        /// <example>
        /// <code>
        /// var array = new Gulpgulpgulpdot.Collections.Array&lt;int&gt;();
        /// array.Resize(10);
        /// array.Fill(0); // Initialize the 10 elements to 0.
        /// </code>
        /// </example>
        ...
        public void Fill(T value)
        {
            ...
            gulpgulpgulpdot_variant variantValue = VariantUtils.CreateFrom(value);
            var self = (gulpgulpgulpdot_array)_underlyingArray.NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_array_fill(ref self, variantValue);
        }
        ...
        /// <example>
        /// <code>
        /// var array = new Gulpgulpgulpdot.Collections.Array&lt;int&gt; { 1, 2, 3, 4 };
        /// GD.Print(array.PickRandom()); // Prints either of the four numbers.
        /// </code>
        /// </example>
        /// <returns>A random element from the array.</returns>
        ...
        /// <example>
        /// <code>
        /// var strings = new Gulpgulpgulpdot.Collections.Array&lt;string&gt; { "string1", "string2", "string10", "string11" };
        /// strings.Sort();
        /// GD.Print(strings); // Prints [string1, string10, string11, string2]
        /// </code>
        /// </example>
        ...
        public unsafe T this[int index]
        {
            get
            {
                _underlyingArray.GetVariantBorrowElementAt(index, out gulpgulpgulpdot_variant borrowElem);
        ...
        public int IndexOf(T item, int index)
        {
            ...
            gulpgulpgulpdot_variant variantValue = VariantUtils.CreateFrom(item);
            var self = (gulpgulpgulpdot_array)_underlyingArray.NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_array_index_of(ref self, variantValue, index);
        }
        ...
        public void AddRange(IEnumerable<T> collection)
        {
            ...
            {
                var self = (gulpgulpgulpdot_array)_underlyingArray.NativeValue;
                var collectionNative = (gulpgulpgulpdot_array)typedArray._underlyingArray.NativeValue;
                _ = NativeFuncs.gulpgulpgulpdotsharp_array_add_range(ref self, collectionNative);
                return;
            }
        ...
        /// <example>
        /// <code>
        /// var arr = new Gulpgulpgulpdot.Collections.Array&lt;string&gt; { "inside", "7" };
        /// GD.Print(arr.Contains("inside")); // True
        /// GD.Print(arr.Contains("outside")); // False
        /// GD.Print(arr.Contains(7)); // False
        /// GD.Print(arr.Contains("7")); // True
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Array<T>(Variant from) => from.AsGulpgulpgulpdotArray<T>();
