...
namespace Gulpgulpgulpdot
{
    ...
    {
        internal gulpgulpgulpdot_node_path.movable NativeValue;
        ...
        private NodePath(gulpgulpgulpdot_node_path nativeValueToOwn)
        {
            NativeValue = (gulpgulpgulpdot_node_path.movable)nativeValueToOwn;
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static NodePath CreateTakingOwnershipOfDisposableValue(gulpgulpgulpdot_node_path nativeValueToOwn)
        ...
        public NodePath(string path)
        {
            ...
            {
                NativeValue = (gulpgulpgulpdot_node_path.movable)NativeFuncs.gulpgulpgulpdotsharp_node_path_new_from_string(path);
                _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
            }
        }
        ...
        public override string ToString()
        {
            ...
            var src = (gulpgulpgulpdot_node_path)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_node_path_as_string(out gulpgulpgulpdot_string dest, src);
            using (dest)
        ...
        {
            gulpgulpgulpdot_node_path propertyPath = default;
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_node_path_get_as_property_path(self, ref propertyPath);
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_node_path_get_concatenated_names(self, out gulpgulpgulpdot_string names);
            using (names)
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_node_path_get_concatenated_subnames(self, out gulpgulpgulpdot_string subNames);
            using (subNames)
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_node_path_get_name(self, idx, out gulpgulpgulpdot_string name);
            using (name)
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_node_path_get_name_count(self);
        }
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_node_path_get_subname(self, idx, out gulpgulpgulpdot_string subName);
            using (subName)
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_node_path_get_subname_count(self);
        }
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_node_path_is_absolute(self).ToBool();
        }
        ...
        public bool Equals([NotNullWhen(true)] NodePath? other)
        {
            if (other is null)
                return false;
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            var otherNative = (gulpgulpgulpdot_node_path)other.NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_node_path_equals(self, otherNative).ToBool();
        }
        ...
        {
            var self = (gulpgulpgulpdot_node_path)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_node_path_hash(self);
        }
    }
}
