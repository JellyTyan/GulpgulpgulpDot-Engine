...
namespace Gulpgulpgulpdot
{
    ...
    public static class StringExtensions
    {
        ...
        {
            using gulpgulpgulpdot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.gulpgulpgulpdotsharp_string_capitalize(instanceStr, out gulpgulpgulpdot_string capitalized);
            using (capitalized)
        ...
        {
            using gulpgulpgulpdot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.gulpgulpgulpdotsharp_string_to_camel_case(instanceStr, out gulpgulpgulpdot_string camelCase);
            using (camelCase)
        ...
        {
            using gulpgulpgulpdot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.gulpgulpgulpdotsharp_string_to_pascal_case(instanceStr, out gulpgulpgulpdot_string pascalCase);
            using (pascalCase)
        ...
        {
            using gulpgulpgulpdot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.gulpgulpgulpdotsharp_string_to_snake_case(instanceStr, out gulpgulpgulpdot_string snakeCase);
            using (snakeCase)
        ...
        {
            using gulpgulpgulpdot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.gulpgulpgulpdotsharp_string_to_kebab_case(instanceStr, out gulpgulpgulpdot_string kebabCase);
            using (kebabCase)
...
#pragma warning restore CA5350
        ...
        {
            using gulpgulpgulpdot_string instanceStr = Marshaling.ConvertStringToNative(instance);
            NativeFuncs.gulpgulpgulpdotsharp_string_simplify_path(instanceStr, out gulpgulpgulpdot_string simplifiedPath);
