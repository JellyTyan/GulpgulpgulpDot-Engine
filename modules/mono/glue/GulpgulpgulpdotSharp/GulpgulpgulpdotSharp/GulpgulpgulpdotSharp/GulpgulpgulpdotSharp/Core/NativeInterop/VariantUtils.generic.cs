...
public partial class VariantUtils
{
    ...
    {
        internal delegate gulpgulpgulpdot_variant ToVariantConverter(scoped in T from);
        internal delegate T FromVariantConverter(in gulpgulpgulpdot_variant from);

        public static unsafe gulpgulpgulpdot_variant ToVariant(scoped in T from) =>
             ToVariantCb != null ? ToVariantCb(from) : throw UnsupportedType<T>();

        public static unsafe T FromVariant(in gulpgulpgulpdot_variant variant) =>
    ...
    public static gulpgulpgulpdot_variant CreateFrom<[MustBeVariant] T>(scoped in T from)
    {
        ...
        if (typeof(T) == typeof(Gulpgulpgulpdot.Collections.Dictionary))
            return CreateFromDictionary(UnsafeAs<Gulpgulpgulpdot.Collections.Dictionary>(from));

        if (typeof(T) == typeof(Gulpgulpgulpdot.Collections.Array))
            return CreateFromArray(UnsafeAs<Gulpgulpgulpdot.Collections.Array>(from));

        if (typeof(T) == typeof(Variant))
            return NativeFuncs.gulpgulpgulpdotsharp_variant_new_copy((gulpgulpgulpdot_variant)UnsafeAs<Variant>(from).NativeVar);
        ...
        if (typeof(GulpgulpgulpdotObject).IsAssignableFrom(typeof(T)))
            return CreateFromGulpgulpgulpdotObject(UnsafeAs<GulpgulpgulpdotObject>(from));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static T ConvertTo<[MustBeVariant] T>(in gulpgulpgulpdot_variant variant)
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        if (typeof(GulpgulpgulpdotObject).IsAssignableFrom(typeof(T)))
            return (T)(object)ConvertToGulpgulpgulpdotObject(variant);
