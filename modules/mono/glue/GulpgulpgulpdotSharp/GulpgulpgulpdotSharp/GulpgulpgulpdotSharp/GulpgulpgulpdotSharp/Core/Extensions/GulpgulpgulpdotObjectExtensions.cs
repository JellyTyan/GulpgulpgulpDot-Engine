...
{
    public partial class GulpgulpgulpdotObject
    {
        /// <summary>
        /// Returns the <see cref="GulpgulpgulpdotObject"/> that corresponds to <paramref name="instanceId"/>.
        ...
        /// <returns>The <see cref="GulpgulpgulpdotObject"/> instance.</returns>
        public static GulpgulpgulpdotObject? InstanceFromId(ulong instanceId)
        {
            return InteropUtils.UnmanagedGetManaged(NativeFuncs.gulpgulpgulpdotsharp_instance_from_id(instanceId));
        }

        /// <summary>
        /// Returns <see langword="true"/> if the <see cref="GulpgulpgulpdotObject"/> that corresponds
        ...
        /// valid <see cref="GulpgulpgulpdotObject"/> (e.g. has not been deleted from memory).
        /// </summary>
        /// <param name="instance">The instance to check.</param>
        /// <returns>If the instance is a valid object.</returns>
        public static bool IsInstanceValid([NotNullWhen(true)] GulpgulpgulpdotObject? instance)
        {
        ...
        /// <returns>
        /// The <see cref="Gulpgulpgulpdot.WeakRef"/> reference to the object or <see langword="null"/>.
        /// </returns>
        public static WeakRef? WeakRef(GulpgulpgulpdotObject? obj)
        {
            if (!IsInstanceValid(obj))
                return null;

            NativeFuncs.gulpgulpgulpdotsharp_weakref(GetPtr(obj), out gulpgulpgulpdot_ref weakRef);
            using (weakRef)
            {
                if (weakRef.IsNull)
                    return null;
