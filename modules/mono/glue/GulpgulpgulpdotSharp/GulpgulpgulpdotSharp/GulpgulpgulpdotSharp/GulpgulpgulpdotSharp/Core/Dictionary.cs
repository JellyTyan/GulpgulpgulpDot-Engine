...
{
    /// <summary>
    /// Wrapper around Gulpgulpgulpdot's Dictionary class, a dictionary of Variant
    ...
    public sealed class Dictionary :
        ...
        IDisposable
    {
        internal gulpgulpgulpdot_dictionary.movable NativeValue;
        ...
        public Dictionary()
        {
            NativeValue = (gulpgulpgulpdot_dictionary.movable)NativeFuncs.gulpgulpgulpdotsharp_dictionary_new();
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        private Dictionary(gulpgulpgulpdot_dictionary nativeValueToOwn)
        {
            NativeValue = (gulpgulpgulpdot_dictionary.movable)(nativeValueToOwn.IsAllocated ?
                nativeValueToOwn :
                NativeFuncs.gulpgulpgulpdotsharp_dictionary_new());
            _weakReferenceToSelf = DisposablesTracker.RegisterDisposable(this);
        }

        // Explicit name to make it very clear
        internal static Dictionary CreateTakingOwnershipOfDisposableValue(gulpgulpgulpdot_dictionary nativeValueToOwn)
        ...
        /// referenced in the source dictionary. Note that any <see cref="GulpgulpgulpdotObject"/> derived
        /// elements will be shallow copied regardless of the <paramref name="deep"/>
        /// setting.
        /// </summary>
        /// <param name="deep">If <see langword="true"/>, performs a deep copy.</param>
        /// <returns>A new Gulpgulpgulpdot Dictionary.</returns>
        public Dictionary Duplicate(bool deep = false)
        {
            gulpgulpgulpdot_dictionary newDictionary;
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_dictionary_duplicate(ref self, deep.ToGulpgulpgulpdotBool(), out newDictionary);
        ...
        public void Merge(Dictionary dictionary, bool overwrite = false)
        {
            ...
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            var other = (gulpgulpgulpdot_dictionary)dictionary.NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_dictionary_merge(ref self, in other, overwrite.ToGulpgulpgulpdotBool());
        }
        ...
        {
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            var otherVariant = (gulpgulpgulpdot_dictionary)other.NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_dictionary_recursive_equal(ref self, otherVariant).ToBool();
        }
        ...
        public ICollection<Variant> Keys
        {
            get
            {
                gulpgulpgulpdot_array keysArray;
                var self = (gulpgulpgulpdot_dictionary)NativeValue;
                NativeFuncs.gulpgulpgulpdotsharp_dictionary_keys(ref self, out keysArray);
        ...
        public ICollection<Variant> Values
        {
            get
            {
                gulpgulpgulpdot_array valuesArray;
                var self = (gulpgulpgulpdot_dictionary)NativeValue;
                NativeFuncs.gulpgulpgulpdotsharp_dictionary_values(ref self, out valuesArray);
        ...
        private (Array keys, Array values, int count) GetKeyValuePairs()
        {
            ...
            int count = NativeFuncs.gulpgulpgulpdotsharp_dictionary_count(ref self);
        ...
        public Variant this[Variant key]
        {
            get
            {
                ...
                if (NativeFuncs.gulpgulpgulpdotsharp_dictionary_try_get_value(ref self,
                        (gulpgulpgulpdot_variant)key.NativeVar, out gulpgulpgulpdot_variant value).ToBool())
                {
            ...
            set
            {
                ...
                var self = (gulpgulpgulpdot_dictionary)NativeValue;
                NativeFuncs.gulpgulpgulpdotsharp_dictionary_set_value(ref self,
                    (gulpgulpgulpdot_variant)key.NativeVar, (gulpgulpgulpdot_variant)value.NativeVar);
            }
        }
        ...
        public void Add(Variant key, Variant value)
        {
            ...
            var variantKey = (gulpgulpgulpdot_variant)key.NativeVar;
            var self = (gulpgulpgulpdot_dictionary)NativeValue;

            if (NativeFuncs.gulpgulpgulpdotsharp_dictionary_contains_key(ref self, variantKey).ToBool())
                throw new ArgumentException("An element with the same key already exists.", nameof(key));

            gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)value.NativeVar;
            NativeFuncs.gulpgulpgulpdotsharp_dictionary_add(ref self, variantKey, variantValue);
        }
        ...
        public void Clear()
        {
            ...
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_dictionary_clear(ref self);
        }
        ...
        {
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_dictionary_contains_key(ref self, (gulpgulpgulpdot_variant)key.NativeVar).ToBool();
        }

        bool ICollection<KeyValuePair<Variant, Variant>>.Contains(KeyValuePair<Variant, Variant> item)
        {
            gulpgulpgulpdot_variant variantKey = (gulpgulpgulpdot_variant)item.Key.NativeVar;
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            bool found = NativeFuncs.gulpgulpgulpdotsharp_dictionary_try_get_value(ref self,
                variantKey, out gulpgulpgulpdot_variant retValue).ToBool();
            ...
            using (retValue)
            {
                ...
                gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.Value.NativeVar;
                return NativeFuncs.gulpgulpgulpdotsharp_variant_equals(variantValue, retValue).ToBool();
            }
        }
        ...
        public bool Remove(Variant key)
        {
            ...
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_dictionary_remove_key(ref self, (gulpgulpgulpdot_variant)key.NativeVar).ToBool();
        }
        ...
        bool ICollection<KeyValuePair<Variant, Variant>>.Remove(KeyValuePair<Variant, Variant> item)
        {
            ...
            using (retValue)
            {
                ...
                gulpgulpgulpdot_variant variantValue = (gulpgulpgulpdot_variant)item.Value.NativeVar;
                if (NativeFuncs.gulpgulpgulpdotsharp_variant_equals(variantValue, retValue).ToBool())
                {
                    return NativeFuncs.gulpgulpgulpdotsharp_dictionary_remove_key(
        ...
        public int Count
        {
            ...
            {
                var self = (gulpgulpgulpdot_dictionary)NativeValue;
                return NativeFuncs.gulpgulpgulpdotsharp_dictionary_count(ref self);
            }
        }
        ...
        public void MakeReadOnly()
        {
            ...
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_dictionary_make_read_only(ref self);
        }
        ...
        public bool TryGetValue(Variant key, out Variant value)
        {
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            bool found = NativeFuncs.gulpgulpgulpdotsharp_dictionary_try_get_value(ref self,
                (gulpgulpgulpdot_variant)key.NativeVar, out gulpgulpgulpdot_variant retValue).ToBool();
        ...
        {
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_dictionary_key_value_pair_at(ref self, index,
                out gulpgulpgulpdot_variant key,
                out gulpgulpgulpdot_variant value);
        ...
        {
            var self = (gulpgulpgulpdot_dictionary)NativeValue;
            NativeFuncs.gulpgulpgulpdotsharp_dictionary_to_string(ref self, out gulpgulpgulpdot_string str);
            using (str)
    ...
    internal interface IGenericGulpgulpgulpdotDictionary
    {
        public Dictionary UnderlyingDictionary { get; }
    }

    /// <summary>
    /// Typed wrapper around Gulpgulpgulpdot's Dictionary class, a dictionary of <typeparamref name="TKey"/>
    ...
    public class Dictionary<[MustBeVariant] TKey, [MustBeVariant] TValue> :
        ...
        IGenericGulpgulpgulpdotDictionary
    {
        private static gulpgulpgulpdot_variant ToVariantFunc(scoped in Dictionary<TKey, TValue> gulpgulpgulpdotDictionary) =>
            VariantUtils.CreateFromDictionary(gulpgulpgulpdotDictionary);

        private static Dictionary<TKey, TValue> FromVariantFunc(in gulpgulpgulpdot_variant variant) =>
        ...
        private void SetTypedForUnderlyingDictionary()
        {
            ...
            {
                NativeFuncs.gulpgulpgulpdotsharp_dictionary_set_typed(
                    ref self,
                    (uint)keyVariantType,
                    keyClassName,
                    keyScriptRef,
        ...
        Dictionary IGenericGulpgulpgulpdotDictionary.UnderlyingDictionary => _underlyingDict;

        internal ref gulpgulpgulpdot_dictionary.movable NativeValue
        {
        ...
        internal static Dictionary<TKey, TValue> CreateTakingOwnershipOfDisposableValue(
            gulpgulpgulpdot_dictionary nativeValueToOwn)
        ...
        /// <returns>A new Gulpgulpgulpdot Dictionary, or <see langword="null"/> if <see paramref="from"/> was null.</returns>
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                var self = (gulpgulpgulpdot_dictionary)_underlyingDict.NativeValue;

                if (NativeFuncs.gulpgulpgulpdotsharp_dictionary_try_get_value(ref self,
                        variantKey, out gulpgulpgulpdot_variant value).ToBool())
                {
                    using (value)
        ...
        public ICollection<TKey> Keys
        {
            get
            {
                gulpgulpgulpdot_array keyArray;
                var self = (gulpgulpgulpdot_dictionary)_underlyingDict.NativeValue;
                NativeFuncs.gulpgulpgulpdotsharp_dictionary_keys(ref self, out keyArray);
        ...
        public bool ContainsKey(TKey key)
        {
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (gulpgulpgulpdot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_dictionary_contains_key(ref self, variantKey).ToBool();
        }
        ...
        public bool Remove(TKey key)
        {
            ...
            using var variantKey = VariantUtils.CreateFrom(key);
            var self = (gulpgulpgulpdot_dictionary)_underlyingDict.NativeValue;
            return NativeFuncs.gulpgulpgulpdotsharp_dictionary_remove_key(ref self, variantKey).ToBool();
        }
        ...
        public static explicit operator Dictionary<TKey, TValue>(Variant from) =>
            from.AsGulpgulpgulpdotDictionary<TKey, TValue>();
