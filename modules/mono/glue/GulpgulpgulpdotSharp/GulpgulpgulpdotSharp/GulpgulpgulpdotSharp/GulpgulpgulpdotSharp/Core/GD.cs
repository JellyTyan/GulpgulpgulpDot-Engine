...
{
    /// <summary>
    /// Gulpgulpgulpdot's global functions.
    /// </summary>
    public static partial class GD
    {
        ...
        public static Variant BytesToVar(Span<byte> bytes)
        {
            ...
            NativeFuncs.gulpgulpgulpdotsharp_bytes_to_var(varBytes, gulpgulpgulpdot_bool.False, out gulpgulpgulpdot_variant ret);
        ...
        {
            using var varBytes = Marshaling.ConvertSystemArrayToNativePackedByteArray(bytes);
            NativeFuncs.gulpgulpgulpdotsharp_bytes_to_var(varBytes, gulpgulpgulpdot_bool.True, out gulpgulpgulpdot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        /// <example>
        /// <code>
        /// Variant a = new Gulpgulpgulpdot.Collections.Array { 4, 2.5, 1.2 };
        ...
        {
            NativeFuncs.gulpgulpgulpdotsharp_convert((gulpgulpgulpdot_variant)what.NativeVar, (int)type, out gulpgulpgulpdot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            return NativeFuncs.gulpgulpgulpdotsharp_hash((gulpgulpgulpdot_variant)var.NativeVar);
        }
        ...
        {
            using var gulpgulpgulpdotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.gulpgulpgulpdotsharp_print(gulpgulpgulpdotStr);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Gulpgulpgulpdot.Collections.Array { 1, 2, 3 };
        ...
        {
            using var gulpgulpgulpdotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.gulpgulpgulpdotsharp_print_rich(gulpgulpgulpdotStr);
        }
        ...
        {
            using var gulpgulpgulpdotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.gulpgulpgulpdotsharp_printerr(gulpgulpgulpdotStr);
        }
        ...
        {
            using var gulpgulpgulpdotStr = Marshaling.ConvertStringToNative(what);
            NativeFuncs.gulpgulpgulpdotsharp_printraw(gulpgulpgulpdotStr);
        }
        ...
        public static void PrintS(params object[] what)
        {
            ...
            using var gulpgulpgulpdotStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.gulpgulpgulpdotsharp_prints(gulpgulpgulpdotStr);
        }
        ...
        public static void PrintT(params object[] what)
        {
            string message = AppendPrintParams('\t', what);
            using var gulpgulpgulpdotStr = Marshaling.ConvertStringToNative(message);
            NativeFuncs.gulpgulpgulpdotsharp_printt(gulpgulpgulpdotStr);
        }

        [StackTraceHidden]
        private static void ErrPrintError(string message, gulpgulpgulpdot_error_handler_type type = gulpgulpgulpdot_error_handler_type.ERR_HANDLER_ERROR)
        {
            ...
            using gulpgulpgulpdot_string messageStr = Marshaling.ConvertStringToNative(message);
            using gulpgulpgulpdot_string callerNameStr = Marshaling.ConvertStringToNative(callerName);
            using gulpgulpgulpdot_string callerFilePathStr = Marshaling.ConvertStringToNative(callerFilePath);
            NativeFuncs.gulpgulpgulpdotsharp_err_print_error(callerNameStr, callerFilePathStr, callerLineNumber, messageStr, p_type: type);
        }

        /// <summary>
        /// Pushes an error message to Gulpgulpgulpdot's built-in debugger and to the OS terminal.
        ///
        ...
        /// <summary>
        /// Pushes a warning message to Gulpgulpgulpdot's built-in debugger and to the OS terminal.
        /// </summary>
        /// <example>
        /// <code>
        ...
        {
            ErrPrintError(message, type: gulpgulpgulpdot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            ErrPrintError(AppendPrintParams(what), type: gulpgulpgulpdot_error_handler_type.ERR_HANDLER_WARNING);
        }
        ...
        {
            return NativeFuncs.gulpgulpgulpdotsharp_randf();
        }
        ...
        {
            return NativeFuncs.gulpgulpgulpdotsharp_randfn(mean, deviation);
        }
        ...
        {
            return NativeFuncs.gulpgulpgulpdotsharp_randi();
        }
        ...
        {
            NativeFuncs.gulpgulpgulpdotsharp_randomize();
        }
        ...
        {
            return NativeFuncs.gulpgulpgulpdotsharp_randf_range(from, to);
        }
        ...
        {
            return NativeFuncs.gulpgulpgulpdotsharp_randi_range(from, to);
        }
        ...
        {
            return NativeFuncs.gulpgulpgulpdotsharp_rand_from_seed(seed, out seed);
        }
        ...
        /// <example>
        /// <code>
        /// ulong mySeed = (ulong)GD.Hash("Gulpgulpgulpdot Rocks");
        /// GD.Seed(mySeed);
        ...
        {
            NativeFuncs.gulpgulpgulpdotsharp_seed(seed);
        }
        ...
        /// var b = GD.StrToVar(a).AsGulpgulpgulpdotDictionary(); // b is a Dictionary
        ...
        {
            using var gulpgulpgulpdotStr = Marshaling.ConvertStringToNative(str);
            NativeFuncs.gulpgulpgulpdotsharp_str_to_var(gulpgulpgulpdotStr, out gulpgulpgulpdot_variant ret);
            return Variant.CreateTakingOwnershipOfDisposableValue(ret);
        }
        ...
        {
            NativeFuncs.gulpgulpgulpdotsharp_var_to_bytes((gulpgulpgulpdot_variant)var.NativeVar, gulpgulpgulpdot_bool.False, out var varBytes);
            using (varBytes)
        ...
        {
            NativeFuncs.gulpgulpgulpdotsharp_var_to_bytes((gulpgulpgulpdot_variant)var.NativeVar, gulpgulpgulpdot_bool.True, out var varBytes);
            using (varBytes)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(varBytes);
        }
        ...
        /// <example>
        /// <code>
        /// var a = new Gulpgulpgulpdot.Collections.Dictionary { ["a"] = 1, ["b"] = 2 };
        ...
        {
            NativeFuncs.gulpgulpgulpdotsharp_var_to_str((gulpgulpgulpdot_variant)var.NativeVar, out gulpgulpgulpdot_string ret);
            using (ret)
        ...
        {
            using gulpgulpgulpdot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(instance);
            NativeFuncs.gulpgulpgulpdotsharp_packed_byte_array_compress(src, (int)compressionMode, out var ret);
            using (ret)
        ...
        /// <para>Note: Decompression is not guaranteed to work with data not compressed by Gulpgulpgulpdot, for example if data compressed with the deflate compression mode lacks a checksum or header.</para>
        /// </summary>
        ...
        {
            using gulpgulpgulpdot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(instance);
            NativeFuncs.gulpgulpgulpdotsharp_packed_byte_array_decompress(src, bufferSize, (int)compressionMode, out var ret);
            using (ret)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(ret);
        }
        ...
        {
            using gulpgulpgulpdot_packed_byte_array src = Marshaling.ConvertSystemArrayToNativePackedByteArray(instance);
            NativeFuncs.gulpgulpgulpdotsharp_packed_byte_array_decompress_dynamic(src, maxOutputSize, (int)compressionMode, out var ret);
            using (ret)
                return Marshaling.ConvertNativePackedByteArrayToSystemArray(ret);
        }
    }
