...
namespace Gulpgulpgulpdot.SourceGenerators.Internal;
        ...
        foreach (var callback in data.Methods)
        {
            ...
            for (int i = 0; i < callback.Parameters.Length; i++)
            {
                ...
                if (parameter.RefKind == RefKind.Out)
                {
                    ...
                    if (IsGulpgulpgulpdotInteropStruct(parameter.Type))
...
");
        ...
        foreach (var callback in data.Methods)
        {
            ...
            foreach (var parameter in callback.Parameters)
            {
                if (IsByRefParameter(parameter))
                {
                    if (IsGulpgulpgulpdotInteropStruct(parameter.Type) || parameter.Type.IsValueType)
                    {
    ...
    private static bool IsGulpgulpgulpdotInteropStruct(ITypeSymbol type) =>
        _gulpgulpgulpdotInteropStructs.Contains(type.FullQualifiedNameOmitGlobal());
    ...
    private static readonly string[] _gulpgulpgulpdotInteropStructs =
    {
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_ref",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_variant_call_error",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_variant",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_string",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_string_name",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_node_path",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_signal",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_callable",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_dictionary",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_byte_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_int32_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_int64_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_float32_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_float64_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_string_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_vector2_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_vector3_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_vector4_array",
        "Gulpgulpgulpdot.NativeInterop.gulpgulpgulpdot_packed_color_array",
    };
}
