...
{
    public sealed partial class GulpgulpgulpdotIdeManager : Node, ISerializationListener
    {
        ...
        private MessagingServer GetRunningOrNewServer()
        {
            ...
            _messagingServer = new MessagingServer(OS.GetExecutablePath(),
                ProjectSettings.GlobalizePath(GulpgulpgulpdotSharpDirs.ResMetadataDir), new GulpgulpgulpdotLogger());
        ...
        public async Task<EditorPick?> LaunchIdeAsync(int millisecondsTimeout = 10000)
        {
            ...
            var editorId = editorSettings.GetSetting(GulpgulpgulpdotSharpEditor.Settings.ExternalEditor).As<ExternalEditorId>();
        ...
        private void LaunchIde(ExternalEditorId editorId, string editorIdentity)
        {
            switch (editorId)
            {
                ...
                case ExternalEditorId.MonoDevelop:
                {
                    ...
                    try
                    {
                        var instance = GetMonoDevelopInstance(GulpgulpgulpdotSharpDirs.ProjectSlnPath);
        ...
        public readonly struct EditorPick
        {
            ...
            public bool IsAnyConnected() =>
                GulpgulpgulpdotSharpEditor.Instance.GulpgulpgulpdotIdeManager.GetRunningOrNewServer().IsAnyConnected(_identity);
                ...
                where TResponse : Response, new()
            {
                ...
                GulpgulpgulpdotSharpEditor.Instance.GulpgulpgulpdotIdeManager
        ...
        private class GulpgulpgulpdotLogger : ILogger
        {
