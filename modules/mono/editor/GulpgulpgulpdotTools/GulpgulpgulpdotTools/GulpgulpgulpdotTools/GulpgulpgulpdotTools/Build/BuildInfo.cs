...
namespace GulpgulpgulpdotTools.Build
{
    ...
    public sealed partial class BuildInfo : RefCounted // TODO Remove RefCounted once we have proper serialization
    {
        ...
        public Gulpgulpgulpdot.Collections.Array CustomProperties { get; private set; } = new();

        public string LogsDirPath => GulpgulpgulpdotSharpDirs.LogsDirPathFor(Solution, Configuration);
        ...
        // Needed for instantiation from Gulpgulpgulpdot, after reloading assemblies
        private BuildInfo()
        {
