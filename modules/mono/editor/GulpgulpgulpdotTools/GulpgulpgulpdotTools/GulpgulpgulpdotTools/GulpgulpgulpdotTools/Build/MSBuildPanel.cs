...
#nullable enable
        ...
        public void BuildProject()
        {
            ...
            GulpgulpgulpdotSharpEditor.Instance.GetNode<HotReloadAssemblyWatcher>("HotReloadAssemblyWatcher").RestartTimer();
        ...
        private void OpenLogsFolder() => OS.ShellOpen(
            $"file://{GulpgulpgulpdotSharpDirs.LogsDirPathFor("Debug")}"
        );
        ...
        public void OnBeforeSerialize()
        {
            ...
            // NOTE:
            // Currently, GulpgulpgulpdotTools is loaded in its own load context. This load context is not reloaded, but the script still are.
