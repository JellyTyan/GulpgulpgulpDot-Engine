    ...
    where TAnalyzer : DiagnosticAnalyzer, new()
{
    ...
    public class Test : CSharpAnalyzerTest<TAnalyzer, DefaultVerifier>
    {
        public Test()
        {
            ...
            {
                Project project =
                    solution.GetProject(projectId)!.AddMetadataReference(Constants.GulpgulpgulpdotSharpAssembly
    ...
    public static Test MakeVerifier(ICollection<string> sources, params DiagnosticResult[] expected)
    {
        ...
        is_global = true
        build_property.GulpgulpgulpdotProjectDir = {Constants.ExecutingAssemblyPath}
        """));
