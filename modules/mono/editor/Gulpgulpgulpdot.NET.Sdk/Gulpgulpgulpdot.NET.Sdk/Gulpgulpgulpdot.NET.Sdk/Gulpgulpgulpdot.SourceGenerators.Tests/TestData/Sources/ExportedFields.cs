...
public partial class ExportedFields : GulpgulpgulpdotObject
{
    ...
    [Export] private GulpgulpgulpdotObject[] _fieldGulpgulpgulpdotObjectOrDerivedArray = { null };
    ...
    // Classes
    [Export] private GulpgulpgulpdotObject _fieldGulpgulpgulpdotObjectOrDerived;
    [Export] private Gulpgulpgulpdot.Texture _fieldGulpgulpgulpdotResourceTexture;
    [Export] private Gulpgulpgulpdot.Texture _fieldGulpgulpgulpdotResourceTextureWithInitializer = new() { ResourceName = "" };
    ...
    [Export]
    private Gulpgulpgulpdot.Collections.Dictionary _fieldGulpgulpgulpdotDictionary = new() { { "foo", 10 }, { Vector2.Up, Colors.Chocolate } };

    [Export]
    private Gulpgulpgulpdot.Collections.Array _fieldGulpgulpgulpdotArray = new() { "foo", 10, Vector2.Up, Colors.Chocolate };

    [Export]
    private Gulpgulpgulpdot.Collections.Dictionary<string, bool> _fieldGulpgulpgulpdotGenericDictionary = new() { { "foo", true }, { "bar", false } };

    [Export]
    private Gulpgulpgulpdot.Collections.Array<int> _fieldGulpgulpgulpdotGenericArray = new() { 0, 1, 2, 3, 4, 5, 6 };
}
