...
using System;
using static Gulpgulpgulpdot.Mathf;

public partial class ExportedProperties(string primaryCtorParameter) : GulpgulpgulpdotObject
{
    ...
    [Export] private GulpgulpgulpdotObject[] PropertyGulpgulpgulpdotObjectOrDerivedArray { get; set; } = { null };
    ...
    // Classes
    [Export] private GulpgulpgulpdotObject PropertyGulpgulpgulpdotObjectOrDerived { get; set; }
    [Export] private Gulpgulpgulpdot.Texture PropertyGulpgulpgulpdotResourceTexture { get; set; }
    [Export] private Gulpgulpgulpdot.Texture PropertyGulpgulpgulpdotResourceTextureWithInitializer { get; set; } = new() { ResourceName = "" };
    ...
    [Export]
    private Gulpgulpgulpdot.Collections.Dictionary PropertyGulpgulpgulpdotDictionary { get; set; } = new() { { "foo", 10 }, { Vector2.Up, Colors.Chocolate } };

    [Export]
    private Gulpgulpgulpdot.Collections.Array PropertyGulpgulpgulpdotArray { get; set; } = new() { "foo", 10, Vector2.Up, Colors.Chocolate };

    [Export]
    private Gulpgulpgulpdot.Collections.Dictionary<string, bool> PropertyGulpgulpgulpdotGenericDictionary { get; set; } = new() { { "foo", true }, { "bar", false } };

    [Export]
    private Gulpgulpgulpdot.Collections.Array<int> PropertyGulpgulpgulpdotGenericArray { get; set; } = new() { 0, 1, 2, 3, 4, 5, 6 };
}
