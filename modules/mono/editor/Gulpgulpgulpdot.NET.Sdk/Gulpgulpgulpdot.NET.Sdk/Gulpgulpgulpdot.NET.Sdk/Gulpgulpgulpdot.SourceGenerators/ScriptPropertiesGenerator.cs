...
namespace Gulpgulpgulpdot.SourceGenerators
{
    ...
    public class ScriptPropertiesGenerator : ISourceGenerator
    {
        ...
        {
            if (context.IsGulpgulpgulpdotSourceGeneratorDisabled("ScriptProperties"))
                return;
        ...
        )
        {
            ...
            bool isToolClass = symbol.GetAttributes().Any(a => a.AttributeClass?.IsGulpgulpgulpdotToolAttribute() ?? false);
            ...
            var gulpgulpgulpdotClassProperties = propertySymbols.WhereIsGulpgulpgulpdotCompatibleType(typeCache).ToArray();
            var gulpgulpgulpdotClassFields = fieldSymbols.WhereIsGulpgulpgulpdotCompatibleType(typeCache).ToArray();
            ...
            foreach (var property in gulpgulpgulpdotClassProperties)
            {
                ...
                source.Append("        public new static readonly global::Gulpgulpgulpdot.StringName @");
            ...
            source.Append("    }\n"); // class GulpgulpgulpdotInternal

            if (gulpgulpgulpdotClassProperties.Length > 0 || gulpgulpgulpdotClassFields.Length > 0)
            {

                // Generate SetGulpgulpgulpdotClassPropertyValue

                bool allPropertiesAreReadOnly = gulpgulpgulpdotClassFields.All(fi => fi.FieldSymbol.IsReadOnly) &&
                                                gulpgulpgulpdotClassProperties.All(pi => pi.PropertySymbol.IsReadOnly || pi.PropertySymbol.SetMethod!.IsInitOnly);

                if (!allPropertiesAreReadOnly)
                {
                    source.Append("    /// <inheritdoc/>\n");
                    source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                    source.Append("    protected override bool SetGulpgulpgulpdotClassPropertyValue(in gulpgulpgulpdot_string_name name, ");
                    source.Append("in gulpgulpgulpdot_variant value)\n    {\n");
                    ...
                    source.Append("        return base.SetGulpgulpgulpdotClassPropertyValue(name, value);\n");

                    source.Append("    }\n");
                }

                // Generate GetGulpgulpgulpdotClassPropertyValue
                bool allPropertiesAreWriteOnly = gulpgulpgulpdotClassFields.Length == 0 && gulpgulpgulpdotClassProperties.All(pi => pi.PropertySymbol.IsWriteOnly);

                if (!allPropertiesAreWriteOnly)
                {
                    source.Append("    /// <inheritdoc/>\n");
                    source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                    source.Append("    protected override bool GetGulpgulpgulpdotClassPropertyValue(in gulpgulpgulpdot_string_name name, ");
                    source.Append("out gulpgulpgulpdot_variant value)\n    {\n");
                    ...
                    source.Append("        return base.GetGulpgulpgulpdotClassPropertyValue(name, out value);\n");

                    source.Append("    }\n");
                }
                // Generate GetGulpgulpgulpdotPropertyList

                const string DictionaryType = "global::System.Collections.Generic.List<global::Gulpgulpgulpdot.Bridge.PropertyInfo>";

                source.Append("    /// <summary>\n")
                    .Append("    /// Get the property information for all the properties declared in this class.\n")
                    .Append("    /// This method is used by Gulpgulpgulpdot to register the available properties in the editor.\n")
                ...
                source.Append("    internal new static ")
                    ...
                    .Append(" GetGulpgulpgulpdotPropertyList()\n    {\n");
                ...
                var gulpgulpgulpdotClassPropertiesAndFields = Enumerable.Empty<GulpgulpgulpdotPropertyOrFieldData>()
                    .Concat(gulpgulpgulpdotClassProperties.Select(propertyData => new GulpgulpgulpdotPropertyOrFieldData(propertyData)))
                    .Concat(gulpgulpgulpdotClassFields.Select(fieldData => new GulpgulpgulpdotPropertyOrFieldData(fieldData)))
                    .OrderBy(data => data.Symbol.Locations[0].Path())
                    .ThenBy(data => data.Symbol.Locations[0].StartLine());

                foreach (var member in gulpgulpgulpdotClassPropertiesAndFields)
                {
        ...
        {
            source.Append("        properties.Add(new(type: (global::Gulpgulpgulpdot.Variant.Type)")
                .Append((int)VariantType.Nil)
                .Append(", name: \"")
                .Append(propertyInfo.Name)
                .Append("\", hint: (global::Gulpgulpgulpdot.PropertyHint)")
                .Append((int)PropertyHint.None)
                .Append(", hintString: \"")
                .Append(propertyInfo.HintString)
                .Append("\", usage: (global::Gulpgulpgulpdot.PropertyUsageFlags)")
        ...
        private static IEnumerable<PropertyInfo> DetermineGroupingPropertyInfo(ISymbol memberSymbol)
        {
            foreach (var attr in memberSymbol.GetAttributes())
            {
                ...
                {
                    GulpgulpgulpdotClasses.ExportCategoryAttr => PropertyUsageFlags.Category,
                    GulpgulpgulpdotClasses.ExportGroupAttr => PropertyUsageFlags.Group,
                    GulpgulpgulpdotClasses.ExportSubgroupAttr => PropertyUsageFlags.Subgroup,
                    _ => null
                };
        ...
        )
        {
            var exportAttr = memberSymbol.GetAttributes()
                .FirstOrDefault(a => a.AttributeClass?.IsGulpgulpgulpdotExportAttribute() ?? false);

            var exportToolButtonAttr = memberSymbol.GetAttributes()
                .FirstOrDefault(a => a.AttributeClass?.IsGulpgulpgulpdotExportToolButtonAttribute() ?? false);
                ...
                static bool ExpressionBodyReturnsNewCallable(Compilation compilation, ArrowExpressionClauseSyntax? expressionSyntax)
                {
                    ...
                    switch (expressionSyntax.Expression)
                    {
                        ...
                        case ObjectCreationExpressionSyntax creationExpression:
                            ...
                            if (typeSymbol != null)
                            {
                                return typeSymbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.Callable;
                            }
                            break;
                        ...
                        case InvocationExpressionSyntax invocationExpression:
                            ...
                            {
                                return methodSymbol.ContainingType.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.Callable;
                            }
                            break;
                    }
        ...
        )
        {
            ...
            if (variantType == VariantType.Object && type is INamedTypeSymbol memberNamedType)
            {
                ...
                if (memberNamedType.InheritsFrom("GulpgulpgulpdotSharp", "Gulpgulpgulpdot.Resource"))
                {
                ...
                if (memberNamedType.InheritsFrom("GulpgulpgulpdotSharp", "Gulpgulpgulpdot.Node"))
                {
            ...
            static string GetTypeName(INamedTypeSymbol memberSymbol)
            {
                if (memberSymbol.GetAttributes()
                    .Any(a => a.AttributeClass?.IsGulpgulpgulpdotGlobalClassAttribute() ?? false))
                {
                    return memberSymbol.Name;
                }

                return memberSymbol.GetGulpgulpgulpdotScriptNativeClassName()!;
            }
            ...
            if (!isTypeArgument && variantType == VariantType.Dictionary)
            {
                ...
                {
                    // To maintain compatibility with previous versions of Gulpgulpgulpdot before 4.4,
