...
namespace Gulpgulpgulpdot.SourceGenerators
{
    internal static class ExtensionMethods
    {
        ...
        public static bool AreGulpgulpgulpdotSourceGeneratorsDisabled(this GeneratorExecutionContext context)
            => context.TryGetGlobalAnalyzerProperty("GulpgulpgulpdotSourceGenerators", out string? toggle) &&
               toggle != null &&
               toggle.Equals("disabled", StringComparison.OrdinalIgnoreCase);

        public static bool IsGulpgulpgulpdotToolsProject(this GeneratorExecutionContext context)
            => context.TryGetGlobalAnalyzerProperty("IsGulpgulpgulpdotToolsProject", out string? toggle) &&
               toggle != null &&
               toggle.Equals("true", StringComparison.OrdinalIgnoreCase);

        public static bool IsGulpgulpgulpdotSourceGeneratorDisabled(this GeneratorExecutionContext context, string generatorName) =>
            AreGulpgulpgulpdotSourceGeneratorsDisabled(context) ||
            (context.TryGetGlobalAnalyzerProperty("GulpgulpgulpdotDisabledSourceGenerators", out string? disabledGenerators) &&
        ...
        public static INamedTypeSymbol? GetGulpgulpgulpdotScriptNativeClass(this INamedTypeSymbol classTypeSymbol)
        {
            var symbol = classTypeSymbol;

            while (symbol != null)
            {
                if (symbol.ContainingAssembly?.Name == "GulpgulpgulpdotSharp")
                    return symbol;
        ...
        public static string? GetGulpgulpgulpdotScriptNativeClassName(this INamedTypeSymbol classTypeSymbol)
        {
            var nativeType = classTypeSymbol.GetGulpgulpgulpdotScriptNativeClass();

            if (nativeType == null)
                return null;

            var gulpgulpgulpdotClassNameAttr = nativeType.GetAttributes()
                .FirstOrDefault(a => a.AttributeClass?.IsGulpgulpgulpdotClassNameAttribute() ?? false);

            string? gulpgulpgulpdotClassName = null;

            if (gulpgulpgulpdotClassNameAttr is { ConstructorArguments: { Length: > 0 } })
                gulpgulpgulpdotClassName = gulpgulpgulpdotClassNameAttr.ConstructorArguments[0].Value?.ToString();

            return gulpgulpgulpdotClassName ?? nativeType.Name;
        }

        private static bool TryGetGulpgulpgulpdotScriptClass(
        ...
        )
        {
            ...
            if (classTypeSymbol?.BaseType == null
                || !classTypeSymbol.BaseType.InheritsFrom("GulpgulpgulpdotSharp", GulpgulpgulpdotClasses.GulpgulpgulpdotObject))
            {
                symbol = null;
                return false;
            }
        ...
        public static IEnumerable<(ClassDeclarationSyntax cds, INamedTypeSymbol symbol)> SelectGulpgulpgulpdotScriptClasses(
        ...
        )
        {
            ...
            {
                if (cds.TryGetGulpgulpgulpdotScriptClass(compilation, out var symbol))
        ...
        public static bool IsGulpgulpgulpdotExportAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.ExportAttr;

        public static bool IsGulpgulpgulpdotSignalAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.SignalAttr;

        public static bool IsGulpgulpgulpdotMustBeVariantAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.MustBeVariantAttr;

        public static bool IsGulpgulpgulpdotClassNameAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.GulpgulpgulpdotClassNameAttr;

        public static bool IsGulpgulpgulpdotGlobalClassAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.GlobalClassAttr;

        public static bool IsGulpgulpgulpdotExportToolButtonAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.ExportToolButtonAttr;

        public static bool IsGulpgulpgulpdotToolAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.ToolAttr;

        public static bool IsSystemFlagsAttribute(this INamedTypeSymbol symbol)
            => symbol.FullQualifiedNameOmitGlobal() == GulpgulpgulpdotClasses.SystemFlagsAttr;

        public static GulpgulpgulpdotMethodData? HasGulpgulpgulpdotCompatibleSignature(
        ...
        )
        {
            ...
            return new GulpgulpgulpdotMethodData(method, paramTypes,
                parameters.Select(p => p.Type).ToImmutableArray(),
                retType != null ? (retType.Value, retSymbol) : null);
        }

        public static IEnumerable<GulpgulpgulpdotMethodData> WhereHasGulpgulpgulpdotCompatibleSignature(
        ...
        )
        {
            ...
            {
                var methodData = HasGulpgulpgulpdotCompatibleSignature(method, typeCache);
        ...
        public static IEnumerable<GulpgulpgulpdotPropertyData> WhereIsGulpgulpgulpdotCompatibleType(
        ...
        )
        {
            foreach (var property in properties)
            {
                ...
                yield return new GulpgulpgulpdotPropertyData(property, marshalType.Value);
            }
        }

        public static IEnumerable<GulpgulpgulpdotFieldData> WhereIsGulpgulpgulpdotCompatibleType(
        ...
        )
        {
            ...
            {
                // TODO: We should still restore read-only fields after reloading assembly. Two possible ways: reflection or turn RestoreGulpgulpgulpdotObjectData into a constructor overload.
                var marshalType = MarshalUtils.ConvertManagedTypeToMarshalType(field.Type, typeCache);

                if (marshalType == null)
                    continue;

                yield return new GulpgulpgulpdotFieldData(field, marshalType.Value);
            }
        }
