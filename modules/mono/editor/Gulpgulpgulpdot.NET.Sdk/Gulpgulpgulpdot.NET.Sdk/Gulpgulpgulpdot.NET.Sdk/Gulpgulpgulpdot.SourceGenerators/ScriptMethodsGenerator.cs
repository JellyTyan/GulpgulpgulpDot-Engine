...
namespace Gulpgulpgulpdot.SourceGenerators
{
    ...
    public class ScriptMethodsGenerator : ISourceGenerator
    {
        ...
        {
            if (context.IsGulpgulpgulpdotSourceGeneratorDisabled("ScriptMethods"))
                return;
        ...
        private class MethodOverloadEqualityComparer : IEqualityComparer<GulpgulpgulpdotMethodData>
        {
            public bool Equals(GulpgulpgulpdotMethodData x, GulpgulpgulpdotMethodData y)
                => x.ParamTypes.Length == y.ParamTypes.Length && x.Method.Name == y.Method.Name;

            public int GetHashCode(GulpgulpgulpdotMethodData obj)
            {
                unchecked
                {
        ...
        )
        {
            ...
            var gulpgulpgulpdotClassMethods = methodSymbols.WhereHasGulpgulpgulpdotCompatibleSignature(typeCache)
            ...
            var distinctMethodNames = gulpgulpgulpdotClassMethods
            ...
            // Generate GetGulpgulpgulpdotMethodList

            if (gulpgulpgulpdotClassMethods.Length > 0)
            {
                const string ListType = "global::System.Collections.Generic.List<global::Gulpgulpgulpdot.Bridge.MethodInfo>";

                source.Append("    /// <summary>\n")
                    .Append("    /// Get the method information for all the methods declared in this class.\n")
                    .Append("    /// This method is used by Gulpgulpgulpdot to register the available methods in the editor.\n")
                ...
                source.Append("    internal new static ")
                    .Append(ListType)
                    .Append(" GetGulpgulpgulpdotMethodList()\n    {\n");

                source.Append("        var methods = new ")
                    .Append(ListType)
                    .Append("(")
                    .Append(gulpgulpgulpdotClassMethods.Length)
                    .Append(");\n");

                foreach (var method in gulpgulpgulpdotClassMethods)
                {
            ...
            if (gulpgulpgulpdotClassMethods.Length > 0)
            {
                ...
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append("    protected override bool InvokeGulpgulpgulpdotClassMethod(in gulpgulpgulpdot_string_name method, ");
                source.Append("NativeVariantPtrArgs args, out gulpgulpgulpdot_variant ret)\n    {\n");
                ...
                source.Append("        return base.InvokeGulpgulpgulpdotClassMethod(method, args, out ret);\n");

                source.Append("    }\n");
            }

            // Generate InvokeGulpgulpgulpdotClassStaticMethod

            var gulpgulpgulpdotClassStaticMethods = gulpgulpgulpdotClassMethods.Where(m => m.Method.IsStatic).ToArray();

            if (gulpgulpgulpdotClassStaticMethods.Length > 0)
            {
                source.Append("#pragma warning disable CS0109 // Disable warning about redundant 'new' keyword\n");
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append("    internal new static bool InvokeGulpgulpgulpdotClassStaticMethod(in gulpgulpgulpdot_string_name method, ");
                source.Append("NativeVariantPtrArgs args, out gulpgulpgulpdot_variant ret)\n    {\n");

                foreach (var method in gulpgulpgulpdotClassStaticMethods)
                {
                    GenerateMethodInvoker(method, source);
                }
            ...
            if (distinctMethodNames.Length > 0)
            {
                source.Append("    /// <inheritdoc/>\n");
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append("    protected override bool HasGulpgulpgulpdotClassMethod(in gulpgulpgulpdot_string_name method)\n    {\n");
                ...
                source.Append("        return base.HasGulpgulpgulpdotClassMethod(method);\n");
        ...
        private static void AppendMethodInfo(StringBuilder source, MethodInfo methodInfo)
        {
            ...
            source.Append(", flags: (global::Gulpgulpgulpdot.MethodFlags)")
        ...
        {
            source.Append("new(type: (global::Gulpgulpgulpdot.Variant.Type)")
            ...
            {
                source.Append(", className: new global::Gulpgulpgulpdot.StringName(\"")
        ...
        private static MethodInfo DetermineMethodInfo(GulpgulpgulpdotMethodData method)
        {
        ...
        private static PropertyInfo DeterminePropertyInfo(MarshalType marshalType, ITypeSymbol typeSymbol, string name)
        {
            ...
            {
                className = namedTypeSymbol.GetGulpgulpgulpdotScriptNativeClassName();
            }
        ...
        private static void GenerateMethodInvoker(
            GulpgulpgulpdotMethodData method,
            StringBuilder source
        )
        {
