...
namespace Gulpgulpgulpdot.SourceGenerators
{
    ...
    public class ScriptSignalsGenerator : ISourceGenerator
    {
        ...
        {
            if (context.IsGulpgulpgulpdotSourceGeneratorDisabled("ScriptSignals"))
                return;
        ...
        )
        {
            ...
            // Generate GetGulpgulpgulpdotSignalList

            if (gulpgulpgulpdotSignalDelegates.Count > 0)
            {
                ...
                source.Append("    /// <summary>\n")
                    ...
                    .Append("    /// This method is used by Gulpgulpgulpdot to register the available signals in the editor.\n")
                ...
                source.Append("    internal new static ")
                    .Append(ListType)
                    .Append(" GetGulpgulpgulpdotSignalList()\n    {\n");

                source.Append("        var signals = new ")
                    .Append(ListType)
                    .Append("(")
                    .Append(gulpgulpgulpdotSignalDelegates.Count)
                    .Append(");\n");

                foreach (var signalDelegateData in gulpgulpgulpdotSignalDelegates)
                {
            ...
            // Generate RaiseGulpgulpgulpdotClassSignalCallbacks
            ...
            if (gulpgulpgulpdotSignalDelegates.Count > 0)
            {
                ...
                source.Append("    [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]\n");
                source.Append(
                    "    protected override void RaiseGulpgulpgulpdotClassSignalCallbacks(in gulpgulpgulpdot_string_name signal, ");
                source.Append("NativeVariantPtrArgs args)\n    {\n");

                foreach (var signal in gulpgulpgulpdotSignalDelegates)
                {
                    GenerateSignalEventInvoker(signal, source);
                }

                source.Append("        base.RaiseGulpgulpgulpdotClassSignalCallbacks(signal, args);\n");
            ...
            if (gulpgulpgulpdotSignalDelegates.Count > 0)
            {
                ...
                source.Append("        return base.HasGulpgulpgulpdotClassSignal(signal);\n");
        ...
        private static MethodInfo DetermineMethodInfo(GulpgulpgulpdotSignalDelegateData signalDelegateData)
        {
        ...
        private static void GenerateSignalEventInvoker(
            GulpgulpgulpdotSignalDelegateData signal,
            StringBuilder source
        )
        {
