    ...
    public sealed class GlobalClassAnalyzer : DiagnosticAnalyzer
    {
        public override ImmutableArray<DiagnosticDescriptor> SupportedDiagnostics
            => ImmutableArray.Create(
                Common.GlobalClassMustDeriveFromGulpgulpgulpdotObjectRule,
        ...
        private static void AnalyzeNode(SyntaxNodeAnalysisContext context)
        {
            ...
            if (context.ContainingSymbol is not INamedTypeSymbol typeSymbol ||
                !typeSymbol.GetAttributes().Any(a => a.AttributeClass?.IsGulpgulpgulpdotGlobalClassAttribute() ?? false))
                return;
            ...
            if (!typeSymbol.InheritsFrom("GulpgulpgulpdotSharp", GulpgulpgulpdotClasses.GulpgulpgulpdotObject))
            {
                context.ReportDiagnostic(Diagnostic.Create(
                    Common.GlobalClassMustDeriveFromGulpgulpgulpdotObjectRule,
                    typeSymbol.Locations.FirstLocationWithSourceTreeOrDefault(),
