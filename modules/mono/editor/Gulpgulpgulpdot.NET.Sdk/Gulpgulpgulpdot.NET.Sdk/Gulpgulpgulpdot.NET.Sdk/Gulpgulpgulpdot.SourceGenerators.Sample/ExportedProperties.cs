...
namespace Gulpgulpgulpdot.SourceGenerators.Sample
{
    ...
    public partial class ExportedProperties : GulpgulpgulpdotObject
    {
        ...
        [Export]
        private Gulpgulpgulpdot.Collections.Dictionary PropertyGulpgulpgulpdotDictionary { get; set; } =
            new() { { "foo", 10 }, { Vector2.Up, Colors.Chocolate } };

        [Export]
        private Gulpgulpgulpdot.Collections.Array PropertyGulpgulpgulpdotArray { get; set; } =
            new() { "foo", 10, Vector2.Up, Colors.Chocolate };

        [Export]
        private Gulpgulpgulpdot.Collections.Dictionary<string, bool> PropertyGulpgulpgulpdotGenericDictionary { get; set; } =
            new() { { "foo", true }, { "bar", false } };

        [Export]
        private Gulpgulpgulpdot.Collections.Array<int> PropertyGulpgulpgulpdotGenericArray { get; set; } =
            new() { 0, 1, 2, 3, 4, 5, 6 };
    }
}
