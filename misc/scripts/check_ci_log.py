...
if (
    ...
    print("FATAL ERROR: Gulpgulpgulpdot has been crashed.")
    sys.exit(52)

# Finding memory leaks in Gulpgulpgulpdot is quite difficult, because we need to take into
...
# It may happen that Gulpgulpgulpdot detects leaking nodes/resources and removes them, so
...
# For now Gulpgulpgulpdot leaks a lot of rendering stuff so for now we just show info
