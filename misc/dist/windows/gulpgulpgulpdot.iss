...
#define MyAppURL "https://gulpgulpgulpdotengine.org/"
#define MyAppExeName "gulpgulpgulpdot.exe"
...
DefaultDirName={localappdata}\Gulpgulpgulpdot
DefaultGroupName=GulpGulpGulpDot Engine
AllowNoIcons=yes
UninstallDisplayIcon={app}\{#MyAppExeName}
#ifdef App32Bit
  OutputBaseFilename=gulpgulpgulpdot-setup-x86
#else
  OutputBaseFilename=gulpgulpgulpdot-setup-x86_64
...
Name: "modifypath"; Description: "Add Gulpgulpgulpdot to PATH environment variable"
